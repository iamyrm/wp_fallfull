...
<a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php printf( esc_attr__( 'Return to %s', 'fallfull' ), esc_attr( get_the_title( $post->post_parent ) ) ); ?>" rev="attachment"><span class="meta-nav">&larr;</span> <?php esc_html_e( 'Return to', 'fallfull' ); ?> <?php echo esc_html( get_the_title( $post->post_parent ) ); ?></a>
