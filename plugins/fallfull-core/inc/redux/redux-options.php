...
$opt_name = 'fallfull_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__('Fallfull Options', FALLFULL_CORE_TEXTDOMAIN),

	// The text to appear on the page title.
	'page_title'                => esc_html__('Fallfull Options', FALLFULL_CORE_TEXTDOMAIN),
...
$args['share_icons'][] = array(
	'url'   => '//github.com/iamyrm/wp_fallfull',
	'title' => __('Visit us on GitHub', FALLFULL_CORE_TEXTDOMAIN),
	'icon'  => 'el el-github',
);

$args['share_icons'][] = array(
	'url'   => '//www.facebook.com/yagya.mj/',
	'title' => __('Like us on Facebook', 'your-textdomain-here'),
	'icon'  => 'el el-facebook',
);

$args['share_icons'][] = array(
	'url'   => '//www.linkedin.com/in/yagyaraj-majhi-0075b1235/',
	'title' => __('Find us on LinkedIn', FALLFULL_CORE_TEXTDOMAIN),
	'icon'  => 'el el-linkedin',
);
...
/*
 * NOTE: SEQUENCE OF THE FILES IMPORTED MATTERS A LOT HERE.
 */
...
if (! function_exists('dynamic_section')) {
	...
	{
		$sections[] = array(
			'title'  => esc_html__('Section via hook', FALLFULL_CORE_TEXTDOMAIN),
			'desc'   => '<p class="description">' . esc_html__('This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', FALLFULL_CORE_TEXTDOMAIN) . '</p>',
...
if (! function_exists('change_defaults')) {
	...
	{
		$defaults['str_replace'] = esc_html__('Testing filter hook!', FALLFULL_CORE_TEXTDOMAIN);
